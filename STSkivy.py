...
# Define Student and Teacher classes
class Student:
...
class FeedbackApp(App):
    def build(self):
        ...
        # Assign default students to teachers
        ...
        # Manager Actions
        main_layout.add_widget(Label(text="Manager Actions", font_size=20))
        main_layout.add_widget(Button(text="Add Teacher", on_press=self.add_teacher))
        main_layout.add_widget(Button(text="Delete Teacher", on_press=self.delete_teacher))
        main_layout.add_widget(Button(text="View All Feedback", on_press=self.view_all_feedback))
        
        # Teacher Actions
        main_layout.add_widget(Label(text="Teacher Actions", font_size=20))
        main_layout.add_widget(Button(text="Manage Teacher", on_press=self.select_teacher))
    ...
    def show_popup(self, title, content):
        ...
        popup_layout.add_widget(Button(text="Close", size_hint=(1, 0.2), on_press=lambda x: popup.dismiss()))
    ...
    def add_teacher(self, instance):
        ...
        layout.add_widget(Button(text="Add", on_press=lambda x: self.save_teacher(input_name.text, popup)))
    ...
    def delete_teacher(self, instance):
        ...
        layout.add_widget(Button(text="Delete", on_press=lambda x: self.remove_teacher(teacher_spinner.text, popup)))
    ...
    def select_teacher(self, instance):
        ...
        layout.add_widget(teacher_spinner)
        layout.add_widget(Button(text="Manage", on_press=lambda x: self.manage_teacher(teacher_spinner.text, popup)))
    ...
    def manage_teacher(self, teacher_name, popup):
        ...
        if teacher:
            ...
            layout.add_widget(Button(text="Give Feedback", on_press=lambda x: self.give_feedback(teacher, student_spinner.text, popup)))
            layout.add_widget(Button(text="Add Student", on_press=lambda x: self.add_student(teacher, popup)))
            layout.add_widget(Button(text="Delete Student", on_press=lambda x: self.delete_student(teacher, student_spinner.text, popup)))
    ...
    def give_feedback(self, teacher, student_name, popup):
        ...
        if student:
            ...
            layout.add_widget(Button(text="Submit", on_press=lambda x: self.save_feedback(student, feedback_input.text, popup)))
            popup.dismiss()
    ...
    def add_student(self, teacher, popup):
        ...
        layout.add_widget(Button(text="Add", on_press=lambda x: self.save_student(teacher, name_input.text, phone_input.text, email_input.text, popup)))
        popup.dismiss()
