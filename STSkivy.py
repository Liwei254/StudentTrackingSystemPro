...
class TeacherScreen(Screen):
    def __init__(self, teacher, **kwargs):
        ...
        layout = GridLayout(cols=1, padding=20, spacing=10, row_default_height=40, size_hint=(0.8, 0.9))
...
class RoleSelectionScreen(Screen):
    def __init__(self, screen_manager, teachers, **kwargs):
        ...
        layout = GridLayout(cols=1, padding=20, spacing=10, row_default_height=40, size_hint=(0.6, 0.8))
